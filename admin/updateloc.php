		...
		<section class="sidebar">
			...
			<div class="content-wrapper">
				...
				<div class="" style="margin-left:30px;margin-bottom: 70px;">
					...
					<!-- form start -->
					<br/>
					<form method="post" enctype="multipart/form-data" action="updateloccode.php">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">Add new location</label>
							<input type="text" name="deptloc" class="form-control" id="exampleInputEmail1" placeholder="Enter location Name" required>
						</div>
