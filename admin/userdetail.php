			...
			<div class="content-wrapper">
                ...
                ?>
								<tr>
									...
									<td >
										<a href="viewusercomp.php?id=<?php echo $row['userid'] ?>" style="color:red"><?php echo "View Complaints";?></a>
									</td>
									<td>
										<?php echo $row['phone'];?>
									</td>
									<td>
										<a href="updateadharcard.php?id=<?php echo $row['userid'] ?>"><img src="images/update.png"></a> &nbsp; | &nbsp;
										<a href="deleteuser.php?id=<?php echo $row['userid'] ?>"><img src="images/delete.png"></a>
									</td>
								</tr>
								<?php
