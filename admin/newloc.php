		...
		<div class="">
			...
			<div class="content-wrapper">
				...
				<div class="" style="margin-left:30px;margin-bottom: 70px;">
					...
					<!-- form start -->
					<br/>
					<form method="post" enctype="multipart/form-data" action="newloccode.php">
						...
						<div class="form-group">
							...
							<input type="text" name="locname" class="form-control" id="exampleInputEmail1" placeholder="Enter location Name" required>
						</div>
