			...
			<div class="content-wrapper">
                ...
                ?>
								<tr>
									...
									<td>
										<?php echo $row['officername']; ?>
									</td>
									
									<td >
										<a href="viewdeptcomp.php?id=<?php echo $row['deptid']; ?>" style="color:red";><?php echo "View Complaints"; ?></a>
									</td>
									...
									<td>
										...
										<a href="deltedept.php?id=<?php echo $row['deptid']; ?>">
