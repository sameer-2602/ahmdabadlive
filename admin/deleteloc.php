			...
			<div class="content-wrapper">
                ...
                ?>
								<tr>
									<td>
										<?php 
			 $sql_select="SELECT `deptname` FROM `department` WHERE `deptid`='$id'";
             $result_select=mysqli_query($connection->myconn,$sql_select);
									...
									<td>
										<a href="updateloc.php"><img src="images/update.png"></a> &nbsp; | &nbsp;
										<a href="deleteloccode.php?id=<?php echo $areaid; ?>"><img src="images/delete.png"></a>
									</td>
								</tr>
								<?php
