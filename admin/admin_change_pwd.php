		...
		<div class="">
			...
			<div class="content-wrapper">
				...
				<div class="" style="margin-left:30px;margin-bottom: 70px;">
					...
					<!-- form start -->
					<br/>
					<form method="post" enctype="multipart/form-data" action="admin_change_pwdcode.php">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<input type="password" name="f_new_pwd" class="form-control" id="exampleInputEmail1" placeholder="Enter Password" required>
						</div>
						
						<div class="form-group">
							<label for="exampleInputEmail1">Confirm password</label>
							<input type="password" name="f_confirm_pwd" class="form-control" id="exampleInputEmail1" placeholder="Enter Re Password" required>
						</div>
