	...
	<header class="type-4">
		...
		<div class="header-top">
			...
			<div class="header-top-entry">
				<div class="title"><img src="img/india.jpg" alt="" />Contact us</div>
			</div>
			<div class="header-top-entry hidden-xs">
				<div class="title"><i class="fa fa-phone"></i>Any question? Call Us <a href="tel:+987123654"><b>+91 999 844 3024</b></a></div>
			</div>
			...
			<?php
				...
				<?php		  										  
					...
					<div class="right-entries">
						...
						<a href="signup.php" class="header-functionality-entry"><i class="fa fa-user-plus"></i><span>Sing up</span></a>
		...
		<div class="navigation">
			...
			<div class="nav-overflow">
					...
					<div class="list">
						...
						<a href="logout.php" class="list-entry">Logout</a>
								...
								<?php
									...
									<a href="signup.php" class="fixed-header-square-button open-search-popup"><i class="fa fa-user-plus" style="padding-right:8px;"></i>  <a href="signup.php" style="text-decoration: none;">Sing up</a></a>
									<?php
												}
				...
				<div class="navigation-footer responsive-menu-toggle-class">
					...
					<div class="navigation-copyright">Created by <a href="http://sukem.in/">Sukem Tech Lab</a>. All rights reserved</div>
				</div>
			</div>
