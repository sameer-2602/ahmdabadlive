                            ...
                            <div class="navigation-banner-swiper">
                                <div class="swiper-container" data-autoplay="5000" data-loop="1" data-speed="500" data-center="0" data-slides-per-view="1">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <input class="simple-field" type="text" placeholder="Your Name" value="" name="uname" />
                                        <div class="clear"></div>
                                    </div>
                                    <div class="col-sm-12">
                                        ...
                                        <input class="simple-field" type="text" placeholder="" required value="" name="ads" />
										
										<label>Phone Number <span>*</span></label>
                                        <input maxlength="10" onkeypress="return isNumberKey(event)" class="simple-field" type="text" placeholder="" required value="" name="phno" />
										
										<label>Pincode<span>*</span></label>
                                        <input maxlength="6" onkeypress="return isNumberKey(event)" class="simple-field" type="text" placeholder="" required value="" name="pin" />                               
